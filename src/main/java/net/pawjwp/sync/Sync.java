...
import net.pawjwp.sync.common.compat.curios.CuriosCompat;
import net.pawjwp.sync.common.compat.diet.DietCompat;
import net.pawjwp.sync.common.compat.thirst.ThirstCompat;
